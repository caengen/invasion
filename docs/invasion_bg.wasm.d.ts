...
export function wasm_bindgen__convert__closures__invoke0_mut__h1f57e2baf5f46d83(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h1f2f85888dbbc55a(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hf82ee2c610ba433d(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h67a6abb246fe2157(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h956768e4c8b194c1(a: number, b: number, c: number): void;
