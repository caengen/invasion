...
export function wasm_bindgen__convert__closures__invoke0_mut__hf8cb7d334655197b(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h1613f199d4edf590(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h3ad5571a2bd83771(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h4f10e9991bec00f6(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h9a90cd032d2f47a8(a: number, b: number, c: number): void;
